...
Future<void> seedCharacters(AppDatabase db) async {
  final characters = [
    ...
    CharactersCompanion.insert(id: 'amelia', name: 'Amelia', phoneNumber: '+1 251 396',
    ...
    CharactersCompanion.insert(id: 'chris', name: 'Chris', phoneNumber: '+1 978 726',
    ...
    CharactersCompanion.insert(id: 'abigail', name: 'Abigail', phoneNumber: '+1 466 098',
      avatarPath: const Value('assets/characters/abigail.png'),
      bio: const Value('If you know, you know.'), colorHex: const Value('#00290a')),
    CharactersCompanion.insert(id: 'michael', name: 'Michael', phoneNumber: '+1 689 140',
