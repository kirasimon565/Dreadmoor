...
class $CharacterNotesTable extends CharacterNotes
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, characterId, noteText, createdAt, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<CharacterNote> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
...
class CharacterNote extends DataClass implements Insertable<CharacterNote> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, characterId, noteText, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
        ...
        [
          ...
          WritePropagation(
            on: TableUpdateQuery.onTableName('characters',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('character_notes', kind: UpdateKind.delete),
            ],
          ),
        ],
      );
...
final class $$CharactersTableReferences
  ...
  static MultiTypedResultKey<$CharacterNotesTable, List<CharacterNote>>
      _characterNotesRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.characterNotes,
              aliasName: $_aliasNameGenerator(
                  db.characters.id, db.characterNotes.characterId));

  $$CharacterNotesTableProcessedTableManager get characterNotesRefs {
    final manager = $$CharacterNotesTableTableManager($_db, $_db.characterNotes)
        .filter((f) => f.characterId.id.sqlEquals($_itemColumn<String>('id')!));
...
typedef $$EpisodesTableProcessedTableManager = ProcessedTableManager<
    ...
    Episode,
    PrefetchHooks Function()>;
typedef $$CharacterNotesTableCreateCompanionBuilder = CharacterNotesCompanion
    Function({
  Value<int> id,
  required String characterId,
  required String noteText,
...
typedef $$CharacterNotesTableUpdateCompanionBuilder = CharacterNotesCompanion
    Function({
  Value<int> id,
  Value<String> characterId,
  Value<String> noteText,
...
final class $$CharacterNotesTableReferences
  ...
  static $CharactersTable _characterIdTable(_$AppDatabase db) =>
      db.characters.createAlias($_aliasNameGenerator(
          db.characterNotes.characterId, db.characters.id));
...
class $$CharacterNotesTableTableManager extends RootTableManager<
    _$AppDatabase,
    $CharacterNotesTable,
    CharacterNote,
    $$CharacterNotesTableFilterComposer,
  ...
  $$CharacterNotesTableTableManager(
      _$AppDatabase db, $CharacterNotesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              ...
              addJoins: <
                ...
                if (characterId) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.characterId,
                    referencedTable:
                        $$CharacterNotesTableReferences._characterIdTable(db),
                    referencedColumn: $$CharacterNotesTableReferences
                        ._characterIdTable(db)
                        .id,
                  ) as T;
                }
...
typedef $$CharacterNotesTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $CharacterNotesTable,
    CharacterNote,
    $$CharacterNotesTableFilterComposer,
