...
class AppsScreen extends ConsumerWidget {
                  ...
                  Column(
                    children: [
                      ...
                      Transform.translate(
                        ...
                        child: Text(
                          formatGameDateFullFromDate(dt).toUpperCase(),
  ...
  Widget _buildAppIcon(
    ...
    final accent =
        isDark ? DreadmoorColors.investigatorCyan : DreadmoorColors.evidenceRed;
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: DreadmoorColors.divider(b), width: 1),
            ),
