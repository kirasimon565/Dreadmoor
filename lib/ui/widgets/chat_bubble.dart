...
class ChatBubble extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // ── COLOURS ───────────────────────────────────────────────────────────────
    // Incoming: Translucent charcoal mist gray.
    // Outgoing: Dark charcoal.
    // Secret: Black charcoal.
    final Color bubbleFill = isSecret
        ? const Color(0xFF111111).withOpacity(0.9) // Black charcoal
        : isMe
        ? const Color(0xFF222222).withOpacity(0.9) // Dark charcoal
        : const Color(0xFF333333).withOpacity(0.7); // Translucent charcoal mist
    ...
    final Color textColor = isSecret
        ? const Color(0xFFFF4444) // Red text accent
          ...
          child: ClipRRect(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // ── SENDER NAME (Group chat only, Incoming only) ──────────────────────────────
                  if (isGroup &&
                      !isMe &&
                      senderId != null &&
                      senderId != 'system' &&
